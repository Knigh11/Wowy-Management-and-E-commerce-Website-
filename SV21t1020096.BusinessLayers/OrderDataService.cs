...
namespace SV21T1020096.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        string searchValue = "")
        {
            rowCount = orderDB.Count(status, fromTime, toTime, searchValue); return orderDB.List(page, pageSize, status, fromTime, toTime, searchValue).ToList();
        }
        public static List<Order> ListOrdersFromCustomer(int id = 0)
        {
            return orderDB.ListFromCustomer(id).ToList();
        }
        /// <summary> 
